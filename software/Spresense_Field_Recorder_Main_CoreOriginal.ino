...
static const int32_t recoding_frames = 18750;
static const int32_t recoding_size = recoding_frames * 6144; /* 4ch, 16bit, 768sample */
...
//uncomment this code for 192000Hz sample rate
 /* err = theAudio->setRenderingClockMode(AS_CLKMODE_HIRES);
  ...
  if (err != AUDIOLIB_ECODE_OK) {
    Serial.println("theAudio->initRecorder error");
    return -1;
  }
